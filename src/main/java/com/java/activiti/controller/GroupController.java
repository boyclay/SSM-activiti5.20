...
public class GroupController {
	...
	public String findGroup(HttpServletResponse response, HttpServletRequest request) throws Exception {
	...
	public String groupPage(HttpServletResponse response, @RequestParam(value = "page", required = false) String page,
