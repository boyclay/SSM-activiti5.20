...
<script type="text/javascript">
	...
	function formatAction(val, row) {
		return "<a href='#' onclick='javascript:openListActionDialog("
				+ row.id
				+ ")'>流程执行过程</a>&nbsp;<a href='#' onclick='javascript:openListCommentDialog("
				+ row.id
...
<body style="margin: 1px">
	<table id="dg" title="已办任务管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true"
		url="${pageContext.request.contextPath}/task/finishedList.action?userId=${currentMemberShip.user.id}&status=1"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
