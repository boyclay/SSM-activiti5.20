...
<body style="margin: 1px">
	...
	<table id="dg" title="待办任务管理" class="easyui-datagrid" fitColumns="true"
		...
		url="${pageContext.request.contextPath}/task/delegateTaskPage.action?userId=${currentMemberShip.user.id }"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="owner" width="100" align="center">委派人</th>
				<th field="assignee" width="100" align="center">代理人</th>
