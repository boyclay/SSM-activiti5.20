...
<script type="text/javascript">
	...
	function formatAction(val, row) {
		return "<a href='javascript:openDelegateTaskTab("
				+ row.id
				+ ")'>委派</a>&nbsp;<a href='javascript:openFinishTaskTab("
				+ row.id
	...
	function submit() {
		$("#fm")
				.form(
						"submit",
						{
							url : '${pageContext.request.contextPath}/task/resolveTask.action',
							onSubmit : function() {
...
<body style="margin: 1px">
	...
	<table id="dg" title="待办任务管理" class="easyui-datagrid" fitColumns="true"
		...
		url="${pageContext.request.contextPath}/task/assignTaskPage.action?userId=${currentMemberShip.user.id }"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
		...
		<form id="fm" method="post">
			<table cellspacing="8px">
				...
				<tr>
					...
					<td colspan="4"><a href="javascript:submit()"
						class="easyui-linkbutton" iconCls="icon-ok">完成</a>
				</tr>
			</table>
		</form>
	</div>
