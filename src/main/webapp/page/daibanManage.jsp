...
<script type="text/javascript">
	...
	function formatAction(val,row){
		return "<a href='javascript:openFinishTaskTab("+row.id+")'>办理任务</a>&nbsp;<a target='_blank' href='${pageContext.request.contextPath}/task/showHisCurrentView.action?taskId="+row.id+"'>查看当前流程图</a>"
	}
